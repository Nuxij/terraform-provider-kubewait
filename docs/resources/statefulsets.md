---
page_title: "kubewait_statefulsets Resource"
description: |-
  Waits for Kubernetes StatefulSets to meet specified conditions.
---

# kubewait_statefulsets Resource

Waits for Kubernetes StatefulSets to meet specified conditions before allowing dependent resources to proceed.

## Example Usage

```terraform
# Wait for statefulsets
resource "kubewait_statefulsets" "example" {
  namespace = "default"
  for       = "condition=Ready"
  timeout   = 300
}
