---
page_title: "kubewait_ingress Resource"
description: |-
  Waits for Kubernetes Ingress resources to meet specified conditions.
---

# kubewait_ingress Resource

Waits for Kubernetes Ingress resources to meet specified conditions before allowing dependent resources to proceed.

## Example Usage

```terraform
# Wait for ingress
resource "kubewait_ingress" "example" {
  namespace = "default"
